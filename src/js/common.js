...
export const create_card_list = (cards_list_dom, info) => {
  info.forEach(element => {
    const doms = create_news()
    cards_list_dom.appendChild(doms.info)
...
export const create_request_list = (request_list_dom, info) => {
  info.forEach(request => {
    ...
    profile.querySelector('p').textContent = `${request.mutualFriendNum} Mutual friends`
